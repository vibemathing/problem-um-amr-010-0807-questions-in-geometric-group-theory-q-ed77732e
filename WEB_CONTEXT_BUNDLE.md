...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:um-amr-010-0807-questions-in-geometric-group-theory-q-ed77732e",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-amr-010-0807-d68cd2646c05",
        "url": "https://www.unsolvedmath.com/problems/AMR-010-0807"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Can Zp∞be embedded in an FP∞-group? Or in an FP3-group? Can an Fn-group be embedded in an Fn+1-group (n ≥2)?",
      "version": 1
    },
    "title": "Questions in Geometric Group Theory — Q 8.7",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "95762cdff4279f6f95fa94ae1b4b58e938e3b3ce1e9cd3c7c673b4544b3a3286"
}
```
